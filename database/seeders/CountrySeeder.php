...
class CountrySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $countries = [
            ...
            ['name' => 'Fiji', 'continent' => 'Australia'],
            ['name' => 'Kiribati', 'continent' => 'Australia'],
            ['name' => 'Marshall Islands', 'continent' => 'Australia'],
            ['name' => 'Micronesia', 'continent' => 'Australia'],
            ['name' => 'Nauru', 'continent' => 'Australia'],
            ['name' => 'New Zealand', 'continent' => 'Australia'],
            ['name' => 'Palau', 'continent' => 'Australia'],
            ['name' => 'Papua New Guinea', 'continent' => 'Australia'],
            ['name' => 'Samoa', 'continent' => 'Australia'],
            ['name' => 'Solomon Islands', 'continent' => 'Australia'],
            ['name' => 'Tonga', 'continent' => 'Australia'],
            ['name' => 'Tuvalu', 'continent' => 'Australia'],
            ['name' => 'Vanuatu', 'continent' => 'Australia'],
